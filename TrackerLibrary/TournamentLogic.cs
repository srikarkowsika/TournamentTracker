...
namespace TrackerLibrary
{
    public static class TournamentLogic
    {
        ...
        public static void AlertUsersToNewRound(this TournamentModel model)
        {
            ...
            List<MatchupModel> currentMatchupRound = model.Rounds.Where(x => x.First().MatchupRound == currentRoundNumber).First();

            foreach (MatchupModel matchup in currentMatchupRound)
            {
        ...
        private static void CompleteTournament(TournamentModel model)
        {
            ...
            body.AppendLine("<h1>We gave a WINNER</h1>");
        ...
        private static void MarkWinnerInMatchups(List<MatchupModel> models)
        {
            ...
            foreach (MatchupModel m in models)
            {
                ...
                if (greaterWins == "0")
                {
                    //0 means true, or low score wins
